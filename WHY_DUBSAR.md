...
Developer plugins for Claude Code, Codex, Cursor and similar hosts remain a
secondary experimentation track. The knowledge gained from them is useful, but
they no longer define DUBSAR's primary public identity.
...
Today, deterministic controls and an API-backed audit path have internal
technical evidence. The complete portal journey, production connectors,
